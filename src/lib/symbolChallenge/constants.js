export const QUESTION_BEHAVIOURS = Object.freeze(["QB-01", "QB-02", "QB-03", "QB-04"]);
export const DIFFICULTY_BEHAVIOURS = Object.freeze({
  D1: Object.freeze(["QB-01", "QB-02", "QB-03"]),
  D2: Object.freeze(["QB-01", "QB-02", "QB-03", "QB-04"]),
  D3: Object.freeze(["QB-01", "QB-02", "QB-03", "QB-04"]),
});
...
export const SUPPORTED_RENDER_MODES = Object.freeze(["TEXT", "MATH", "GRAPHIC"]);
export const CONTEXT_CONSTRAINTS = Object.freeze({
  ...
  CATEGORY_SCAFFOLD_REQUIRED: "category_scaffold_required",
});
...
export const GENERATOR_VERSION = "MSG-QG-1.0-B2";
