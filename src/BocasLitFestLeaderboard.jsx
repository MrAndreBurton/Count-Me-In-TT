...
export default function BocasLitFestLeaderboard() {
  ...
  useEffect(() => {
    ...
    const load = async () => {
      try {
        ...
        console.error("Bocas leaderboard load error:", e);
        if (cancelled) return;
  ...
  />
        ...
        >
          🏆 Bocas Lit Fest 2026 Leaderboard 🏆
        </h1>

        <p style={{ fontSize: 18, fontWeight: "bold", marginTop: 10 }}>
          Congratulations to all our top players!
        </p>
      ...
      <div style={{ marginTop: 80 }}>
        ...
        >
          <img
            src="/bocas-sponsor1.svg"
            alt="Bocas Sponsor 1"
            style={{ height: "120px", maxWidth: "250px", objectFit: "contain" }}
          />
          <img
            src="/bocas-sponsor2.svg"
            alt="Bocas Sponsor 2"
            style={{ height: "120px", maxWidth: "250px", objectFit: "contain" }}
          />
          <img
            src="/bocas-sponsor3.svg"
            alt="Bocas Sponsor 3"
            style={{ height: "120px", maxWidth: "250px", objectFit: "contain" }}
          />
        </div>
        ...
        >
          ...
          >
            © 2025 - 2026 <span style={{ fontWeight: 600 }}>Count Me In TT</span>. Developed by{" "}
