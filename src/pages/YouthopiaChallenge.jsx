...
const YOUTHOPIA_SHEET_URL =
"https://docs.google.com/spreadsheets/d/e/2PACX-1vT8NpSVQbA8VDx9oyshFTgTpn6ykBG7FC7pbJPHmNoraNQo4Nfr2JCPQyfInDivj0VXbynrXRy_Q-R_/pub?gid=0&single=true&output=csv";

const YOUTHOPIA_WEBHOOK =
"https://script.google.com/macros/s/AKfycbyOjK2i__FPG34QxwO72OVKzHAkAZAjNtBBF6c17PYSoAM4VugoV-IOpwvr99Bl3_qeMA/exec";

const EVENT_NAME = "Youthopia 2";

// Update this after confirming the event date/time.
// This controls when submissions close.
const EVENT_END = new Date("2026-06-14T14:00:00-04:00");
...
export default function YouthopiaChallenge() {
  ...
  const loadTopThree = async () => {
    try {
      ...
      const res = await fetch(YOUTHOPIA_SHEET_URL, { cache: "no-store" });
      ...
      console.error("Youthopia top three load error:", e);
      setTopThree([]);
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    if (new Date() > EVENT_END) {
      alert("Submissions for the Youthopia 2 Challenge are now closed.");
      return;
    }

    if (
      !YOUTHOPIA_WEBHOOK ||
      YOUTHOPIA_WEBHOOK === "PASTE_YOUTHOPIA_WEBHOOK_URL_HERE"
    ) {
      alert("Youthopia submission webhook has not been added yet.");
      return;
    }
      ...
      {showIntro ? (
        <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50 px-4">
          <div className="bg-white text-black p-6 rounded shadow max-w-md text-center space-y-4">
            <h2 className="text-xl font-bold">🚀 Welcome to the Youthopia Challenge!</h2>
        ...
        <div className="space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
            <div className="flex items-center space-x-3">
              ...
              <div className="text-left">
                <h1 className="text-3xl font-bold">Youthopia 2 Challenge</h1>
          ...
          >
            <div className="youthopia-logo-wrap">
              <img
              ...
              {/* Add this file later if you have a Youthopia logo */}
              {/* <img
                src="/logo-youthopia.svg"
                alt="Youthopia"
                style={{ maxHeight: 200, width: "auto" }}
              /> */}
            </div>
            ...
            <div className="bg-white rounded-lg shadow p-4 border border-yellow-300">
              ...
              <div className="text-center mt-4">
                <p className="text-black text-sm drop-shadow-[2px_2px_3px_rgba(0,0,0,0.75)] animate-shimmer bg-clip-text">
                  ⭐ Play and beat your fastest time. Compete to see your name on the Youthopia Leaderboard! ⭐
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50 px-4">
          ...
          >
            ...
            <p className="text-center text-sm text-gray-600">
              Enter your name and email to appear on the Youthopia leaderboard.
            </p>
