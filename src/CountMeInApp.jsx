  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/students/:studentId/badges" element={<Badges />} />
 
        <Route path="/students/:studentId/results" element={<ResultsHistory />} />
        ...
        <Route
          path="/play"
          element={<Navigate to="/games/multiplication" replace />}
        />

        <Route
          path="/5x5grid"
          element={<CoreGame initialPreset="5x5" lockPreset />}
        />

        <Route
          path="/5x12grid"
          element={<CoreGame initialPreset="5x12" lockPreset />}
        />

        <Route
          path="/12x12grid"
          element={<CoreGame initialPreset="12x12" lockPreset />}
        />

        <Route
          path="/15x15grid"
          element={<CoreGame initialPreset="15x15" lockPreset />}
        />
